...
df = pd.read_csv("monthly_PM25.csv")
...
print "Mean PM2.5 Concentrations for individual months in mg/m3"
...
layout = go.Layout(
     barmode='group',
        title='Mean Monthly Concentration Analysis For PM2.5',
    xaxis=dict(
        title='Months',
        titlefont=dict(
...
py.plot(fig, filename='Mean_Monthly_Concentration_Analysis_For_PM2.5')